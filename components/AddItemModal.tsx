        ...
        <div className="fixed top-0 left-0 w-full h-full bg-slate-950/30 px-4 overflow-auto z-50">
            <div className="max-w-xl mx-auto my-12 bg-white rounded-lg shadow relative">
                ...
                <div className="border-t px-7 py-5">
                    ...
                    <p className="text-sm text-gray-500 mt-5 mb-2">영양 성분의 기준이 될 중량/개수를 입력해주세요.</p>
                    <ul>
                        <li className="flex gap-2 mb-2 items-center">
                        ...
                        <li className="flex gap-2 mb-2 items-center">
                            ...
                            <input type="text" className="border rounded grow py-2 px-3 text-sm" defaultValue={1} />
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li className="flex gap-2 mb-2 items-center">
                            ...
                            <input type="text" className="border rounded grow py-2 px-3 text-sm" disabled={!jiChkbox} />
                        </li>
                    </ul>
